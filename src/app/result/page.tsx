      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-6xl mx-auto px-4 py-8">
                ...
                <div className="text-center mb-8">
                  ...
                  <div className="flex items-center justify-center gap-6 mb-6">
                    ...
                    <button
                      ...
                      className="bg-[#407A81] text-white rounded-full px-8 py-4 hover:bg-[#326269] transition-colors flex items-center gap-3 shadow-lg"
                    >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mt-10">
            <button
              onClick={handleSave}
              className="bg-[#407A81] text-white py-4 px-8 rounded-xl hover:bg-[#326269] transition-colors font-semibold text-lg shadow-lg"
            >
              Simpan
            </button>
            <button
              onClick={handleDelete}
              className="flex items-center justify-center gap-3 bg-white border-2 border-red-500 text-red-500 py-4 px-8 rounded-xl hover:bg-red-50 transition-colors font-semibold shadow-lg"
            >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
          ...
          <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-4xl p-6 md:p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
              <div className="bg-[#E9F6F7] rounded-xl p-4 border border-cyan-200">
                <p className="text-xs text-gray-600 mb-1 text-center">Tinggi Badan</p>
                <div className="flex items-center justify-between">
                  <p className="text-2xl font-bold text-[#407A81]">{childData.height}</p>
                  <Image src="/image/icon/tinggi-badan.svg" alt="Tinggi" width={40} height={40} />
                </div>
              </div>
              <div className="bg-[#E9F6F7] rounded-xl p-4 border border-cyan-200">
                <p className="text-xs text-gray-600 mb-1 text-center">Berat Badan</p>
                <div className="flex items-center justify-between">
                  <p className="text-2xl font-bold text-[#407A81]">{childData.weight}</p>
                  <Image src="/image/icon/berat-badan.svg" alt="Berat" width={40} height={40} />
                </div>
              </div>
            </div>
            ...
            <div className="flex justify-center">
              <button
                ...
                className="w-full md:w-1/2 bg-[#407A81] text-white py-3 rounded-full hover:bg-[#326269] transition-colors"
              >
                Tutup
              </button>
            </div>
